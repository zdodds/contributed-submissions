...
# The third plot: Hexbin plot with marginal distributions
import numpy as np
import seaborn as sns
...
# The 4th plot: Different cubehelix palettes
import numpy as np
import seaborn as sns
import matplotlib.pyplot as plt
...
#1 use housing data set, find when the house is built(Year Built) and when the garage is built (Garage Yr Blt)

import pandas as pd
housing = pd.read_csv('./housing.csv')


build_garage= housing[["Year Built", "Garage Yr Blt"]]
build_garage

build_garage.to_csv('build_garage.csv', index=False)
...
# Load the example dataset of build_garage
df = pd.read_csv("build_garage.csv")
# find the difference between Garage Yr Blt and Year Built
df["Difference"] = df["Garage Yr Blt"] - df["Year Built"]
# Draw a violinplot 
sns.violinplot(y="Difference", data=df)
plt.title("The differences between when the garage is built and when the house is built")
plt.show()



# Compare the sepalwid of different types of irises, including alieniris
import pandas as pd
iris = pd.read_csv('./iris.csv')

iris_wid= iris[["irisname", "sepalwid","petalwid"]]
iris_wid.to_csv('iris_wid.csv', index=False)
iris_wid



#2 investigate the density distribution of sepalwid for different irises
import pandas as pd
import seaborn as sns
import matplotlib.pyplot as plt
...
iris_wid= pd.read_csv("./iris_wid.csv")
sns.displot(data=iris, x="sepalwid", kind="kde", hue="irisname")
plt.show()



#3 Newborn distribution for each month
import pandas as pd
newborn = pd.read_csv('./births.csv')

newborn2= newborn[["month", "day","births"]]
newborn2.to_csv('newborn2.csv', index=False)
...
newborn2 = pd.read_csv('./newborn2.csv')
...
#4 Compare the math score distribution of students in different years
import pandas as pd
students = pd.read_csv('./NY_Math_Test_Results_2006-2012.csv')



import pandas as pd
students = pd.read_csv('./NY_Math_Test_Results_2006-2012.csv')
student_grade = students[['Grade','Num Level 1','Num Level 2','Num Level 3','Num Level 4']]
student_grade



student_grade = student_grade.iloc[[0, 7, 14, 23, 28, 35]]
student_grade
...
plt.title("Number of Students by Grade and Math Level")
plt.show()
...
# feel free to use these and additional cells...
import pandas as pd
estates = pd.read_csv('./Real estate.csv')



estates2 = estates[['X2 house age','X3 distance to the nearest MRT station']]
...
# Create and fit the model
model = LinearRegression()
X = estates2[['X2 house age']].values  # Input feature as 2D array
y = estates2['X3 distance to the nearest MRT station'].values    # Target variable as 1D array
model.fit(X, y)
...
plt.ylabel('Distance to the MRT station') 
plt.title('Linear Regression: House age vs Distance to the MRT station')
plt.legend()
plt.show()
...
print(f"Slope: {model.coef_[0]:.4f}")
print(f"Intercept: {model.intercept_:.4f}")
#it seems that linear regression isn't the best choice :( 
